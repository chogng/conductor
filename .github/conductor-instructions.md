...
Conductor Studio  is built with a layered architecture using TypeScript, web APIs and Electron, combining web technologies with native app capabilities. The codebase is organized into key architectural layers:
...
- `resources/`: Static resources, including platform packaging assets under `resources/win32`, `resources/darwin`
...
- **Layered architecture** - from `base`, `platform`, to `workbench`
