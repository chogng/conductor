...
| raw import conversion | Explorer source workflow + files conversion helpers + `ISessionService.commitFileImport(...)` |
...
- Do not inline Explorer import conversion/session import commit in command handlers; delegate to Explorer source workflow.
