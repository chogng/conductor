...
Current assessment code still produces migration table facts consumed by recipe
interpretation. Recipe must not infer measurement family, roles, units, or
table structure from raw rows.
