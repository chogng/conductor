...
export const iconFontSize = registerSize('iconFontSize',
	sizeForAllThemes(16, 'px'),
	nls.localize('iconFontSize', "Base font size for icons."));

export const iconFontSizeCompact = registerSize('iconFontSize.compact',
	sizeForAllThemes(12, 'px'),
	nls.localize('iconFontSizeCompact', "Compact font size for icons."));
