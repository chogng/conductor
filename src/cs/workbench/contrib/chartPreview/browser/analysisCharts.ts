...
import { normalizeAxisTitleOverridesByFileId, normalizeChartYScale, normalizeLinearLogScale, normalizeLogCurrentMode, normalizeSeriesLegendLabelsByFileId, normalizeVisibleSeriesByFileId, normalizeYLogCurrentModeByFileIdRecord, normalizeYScaleByFileIdRecord, type AxisTitleOverridesByFileId, } from "src/cs/workbench/contrib/chart/browser/chartModel";
...
import { DEFAULT_PLOT_AXIS_SETTINGS, normalizePlotAxisSettings, type PlotAxisSettings, } from "src/cs/workbench/contrib/chart/common/plotAxisSettings";
import { isOriginExportMode, resolveSeriesLabel, type OriginExportContentKey, type OriginExportMode, } from "src/cs/workbench/contrib/export/common/originSelectionExport";
import type { ToastState, ToastType } from "src/cs/workbench/common/deviceAnalysis/sharedTypes";
import { useAnalysisFileCache } from "src/cs/workbench/contrib/diagnostics/browser/useAnalysisFileCache";
import { useOriginCanvasExport, resolveOriginSeriesMatchTokens, type OriginFilteredCanvasKind, type OriginCanvasExportScope, type OriginCurveExportMode, } from "src/cs/workbench/contrib/export/browser/originCanvasExport";
import { createExportPaneState, getCanvasScopeSummary, getExportSelectionSummary, } from "src/cs/workbench/contrib/export/browser/exportModel";
import { useFileSelectionPool } from "src/cs/workbench/contrib/preview/browser/fileSelectionModel";
import { useWorkbenchSidebarPortal, } from "src/cs/workbench/browser/layout";
...
import { computeBaseCurrentMetrics, isOutputLikeFile, isTransferLikeFile, } from "../../diagnostics/common/metrics";
import { ANALYSIS_CACHE_VERSION, canUseCachedBaseCurrent, } from "../../diagnostics/common/analysisCachePolicy";
import { DEVICE_ANALYSIS_CAPACITANCE_Y_UNIT_VALUES, DEVICE_ANALYSIS_CURRENT_Y_UNIT_VALUES, getXUnitMeta, getYUnitMeta, isCapacitanceYUnit, isCurrentYUnit, normalizeYUnit, type YUnit, } from "src/cs/workbench/contrib/chart/common/units";
...
import GmDiagnosticsChart from "src/cs/workbench/contrib/diagnostics/browser/GmDiagnosticsChart";
import SsDiagnosticsChart from "src/cs/workbench/contrib/diagnostics/browser/SsDiagnosticsChart";
import SsSummaryStrip from "src/cs/workbench/contrib/diagnostics/browser/SsSummaryStrip";
import AnalysisDiagnosticsCard from "src/cs/workbench/contrib/diagnostics/browser/AnalysisDiagnosticsCard";
import { createDiagnosticsContextBadges } from "src/cs/workbench/contrib/diagnostics/browser/diagnosticsModel";
import AxisSettingsPane from "src/cs/workbench/contrib/chart/browser/AxisSettingsPane";
...
const ANALYSIS_COMPACT_PAGE_FIELD_CLASS = "!h-8 !gap-0 rounded-lg border border-border bg-bg-page px-2 py-1";
...
const areOriginCurveSelectionSeriesEqual = (prev: OriginCurveSelectionSeriesEntry, next: OriginCurveSelectionSeriesEntry) => prev.key === next.key && prev.label === next.label && prev.selected === next.selected;
const OriginCurveSelectionSeriesChip = React.memo(function OriginCurveSelectionSeriesChip({ curveMode, fileId, onSetCurveMode, onToggleSeriesForFile, series, }: {
...
}, (prev, next) => prev.curveMode === next.curveMode &&
...
const areOriginCurveSelectionEntriesEqual = (prev: OriginCurveSelectionEntry, next: OriginCurveSelectionEntry) => {
    if (prev.allSeriesSelected !== next.allSeriesSelected ||
        prev.fileId !== next.fileId ||
...
const OriginCurveSelectionEntryRow = React.memo(function OriginCurveSelectionEntryRow({ curveMode, entry, exportEntryActionLabel, fileCurvesLabel, isSelectionMode, onClearAllSeriesForFile, onRemoveEntry, onSelectAllSeriesForFile, onSelectFile, onSetCurveMode, onToggleFile, onToggleSeriesForFile, pickAllLabel, renderFileExtra, selectedBadgeLabel, showRemoveButton, showSeriesControls, }: {
    curveMode: OriginCurveExportMode;
            ...
            jsxs("div", {
                ...
                children: [
                    jsx("div", {
                        ...
                        children: jsxs("div", {
                            className: "flex items-center gap-2 flex-wrap text-[11px] text-text-secondary",
                            children: [
                                jsx("button", {
                                    type: "button",
                                ...
                                jsx("span", {
                                    className: "inline-flex items-center rounded-full bg-bg-surface px-2 py-0.5",
                                    children: fileCurvesLabel
                                }),
                                isSelectionMode && entry.isCanvasSelected ? (jsx("span", {
                                    className: "inline-flex items-center rounded-full bg-accent-terracotta/15 px-2 py-0.5 text-accent-terracotta",
                                    children: selectedBadgeLabel
                                })) : null
                            ]
                        })
                    }),
                        ...
                        jsxs("button", {
                            ...
                            children: [
                                ...
                                jsx("span", {
                                    ...
                                    children: pickAllLabel
                                })
                            ]
                        }),
                        entry.series.map((series) => (jsx(OriginCurveSelectionSeriesChip, {
                            key: series.key,
                            curveMode: curveMode,
                            fileId: entry.fileId,
...
const shouldUseStartupDefaultYScale = (fileLike: any): boolean => isTransferLikeFile(fileLike) || isLinearDefaultCurve(fileLike);
...
const normalizeYUnitByFileIdRecord = (value: unknown): Record<string, YUnit> => {
    ...
    const next: Record<string, YUnit> = {};
...
const PlotTypeToggle = React.memo(function PlotTypeToggle({ activePlotType, primaryPlotLabel, derivativeLabel, gmApplicable, ssApplicable, vthApplicable, areaAvailable, onChange, }: {
    ...
    return (jsx(Tabs, {
        ...
        onChange: (next: unknown) => selectPlotType(next as PlotTypeOption),
        size: "sm",
        hoverPreview: false,
...
const makeStrictLinearDomain = (min: unknown, max: unknown): [
    number,
    number
] => {
...
const makeStrictLogDomain = (min: unknown, max: unknown): [
    number,
    number
] | null => {
    const minValue = Number(min);
...
const resolveDiagnosticsBaseYDomain = (minMax: {
    minY: number | null;
    maxY: number | null;
...
const buildDiagnosticsYTicks = (domain: [
    number,
    number
]) => {
...
const resolveTickedDomain = (baseDomain: [
    number,
    number
], ticks: unknown): [
    number,
...
const resolveScaledRangeFromTicks = ({ domain, inferStep, scaleFactor, ticks, }: {
    domain: [
        number,
        number
    ];
...
const AnalysisCharts = ({ processedData, processingStatus, activeFileId: controlledActiveFileId = undefined, onActiveFileIdChange = undefined, showFileSelect = true, ionIoffMethod = "auto", setIonIoffMethod = () => { }, ionIoffManualTargetsByFileId = {}, setIonIoffManualTargetsByFileId = () => { }, ssMethod = "auto", setSsMethod = () => { }, ssDiagnosticsEnabled = true, setSsDiagnosticsEnabled = () => { }, vthDiagnosticsEnabled = false, setVthDiagnosticsEnabled = () => { }, gmDiagnosticsEnabled = false, setGmDiagnosticsEnabled = () => { }, ssShowFitLine = true, setSsShowFitLine = () => { }, ssManualRanges = {}, setSsManualRanges = () => { }, originOpenPlotOptions = DEFAULT_ORIGIN_PLOT_OPTIONS, onOriginOpenPlotOptionsChange = undefined, }: any) => {
    ...
    const parametersService = useMemo(() => new BrowserParametersService(), []);
    const parametersViewRef = useRef<HTMLDivElement | null>(null);
    const rcToolbarRef = useRef<HTMLDivElement | null>(null);
    const rcSummaryRef = useRef<HTMLDivElement | null>(null);
    const rcCurveHeaderRef = useRef<HTMLDivElement | null>(null);
    const rcCurveRowsRef = useRef<HTMLDivElement | null>(null);
    const parametersPaneRef = useRef<ParametersViewPane | null>(null);
    const rcSummaryPaneRef = useRef<ParametersViewPane | null>(null);
    const rcCurveHeaderPaneRef = useRef<ParametersViewPane | null>(null);
    const rcCurveRowsPaneRef = useRef<ParametersViewPane | null>(null);
    const isMountedRef = useRef(true);
    const rcAnalyzeRequestIdRef = useRef(0);
    useEffect(() => () => {
        isMountedRef.current = false;
        parametersPaneRef.current?.dispose();
        rcSummaryPaneRef.current?.dispose();
        rcCurveHeaderPaneRef.current?.dispose();
        rcCurveRowsPaneRef.current?.dispose();
    }, []);
    ...
    const originChartXRangeRef = useRef<{
        min: number;
        max: number;
        step?: number | null;
    } | null>(null);
    const originChartYRangeRef = useRef<{
        mode: "linear" | "log";
        min: number;
        max: number;
        step?: number | null;
    ...
    const originExportContentOptions = useMemo(() => resolveOriginExportContentOptionsForFile(activeFile), [activeFile]);
    const resolvedOriginExportContentKeys = useMemo(() => normalizeOriginExportContentKeysForOptions(originExportContentKeys, originExportContentOptions), [originExportContentKeys, originExportContentOptions]);
    useEffect(() => {
    ...
    const hasManualAxisOverride = useMemo(() => {
        const hasManualXRange = parseOptionalNumber(axis?.xMin) !== null || parseOptionalNumber(axis?.xMax) !== null;
        const hasManualYRange = parseOptionalNumber(axis?.yMin) !== null || parseOptionalNumber(axis?.yMax) !== null;
        ...
        const hasManualYDecadeStep = manualYDecadeStep !== null && Math.round(manualYDecadeStep) !== 1;
        const manualXTickCount = parseOptionalNumber(axis?.xTickCount);
        const hasManualXTickCount = manualXTickCount !== null && Math.round(manualXTickCount) !== 6;
        const manualYTickCount = parseOptionalNumber(axis?.yTickCount);
        const hasManualYTickCount = manualYTickCount !== null && Math.round(manualYTickCount) !== 6;
        ...
        const hasManualMinorTickCount = manualMinorTickCount !== null && Math.round(manualMinorTickCount) !== 1;
    ...
    const { clearOriginSeriesSelectionForFile, curveExportMode: resolvedCurveExportMode, getSelectedOriginSeriesKeySetForFile, handleExportOriginZip, handleOpenInOrigin, replaceMatchingOriginSeriesAcrossFiles, replaceOriginCanvasSelection, originExportMode: resolvedOriginExportMode, scopedOriginCanvasKeySet, selectAllOriginSeriesForFile, selectedOriginCanvasKeySet, selectedOriginSeriesCountByFile, selectedOriginSeriesTotalCount, toggleOriginCanvasSelection, toggleOriginSeriesSelectionForFile, } = useOriginCanvasExport({
        activeFile,
    ...
    const { isExportListCanvasSelectionMode, isExportPaneActive, isManualCanvasScope, showFilteredCanvasKindSelect, } = createExportPaneState({
        originCanvasExportScope,
        resultsTab,
    });
    const separateCanvasScopeSummary = useMemo(() => getCanvasScopeSummary({
        originCanvasExportScope,
        originFilteredCanvasKind,
        selectedCanvasCount,
        t,
    }), [originCanvasExportScope, originFilteredCanvasKind, selectedCanvasCount, t]);
    const exportSelectionSummary = getExportSelectionSummary({
    ...
    const scopedOriginCanvasIds = useMemo(() => Array.from(scopedOriginCanvasKeySet ?? new Set<string>()), [scopedOriginCanvasKeySet]);
    const originCurveExportOptions = useMemo<OriginCurveExportSeriesOption[]>(() => {
        ...
        for (const file of Array.isArray(processedData) ? processedData : []) {
            const fileId = String(file?.fileId ?? "").trim();
            if (!fileId || !scopedIds.has(fileId))
                continue;
    ...
    const selectedOriginCurveExportOptionKeySet = useMemo(() => {
        ...
        for (const file of Array.isArray(processedData) ? processedData : []) {
            ...
            for (const series of seriesList) {
                const seriesId = String(series?.id ?? "").trim();
                if (!seriesId || !selectedSeriesKeys.has(seriesId))
                    continue;
                const tokens = resolveOriginSeriesMatchTokens(series);
    ...
    const rcStatisticAvailableFileIds = useMemo(() => (Array.isArray(processedData) ? processedData : [])
        .filter((file: any) => isTransferLikeFile(file))
        .map((file: any) => String(file?.fileId ?? "").trim())
        .filter(Boolean), [processedData]);
    const { selectedFileIdSet: selectedRcStatisticFileIdSet, toggleFileSelection: toggleRcStatisticFileSelection, } = useFileSelectionPool({
    ...
    useEffect(() => {
        if (resolvedCurveExportMode !== "select")
            return;
        if (!Array.isArray(originCurveExportSelectedKeys))
            return;
    ...
    const rcTransferAvailable = useMemo(() => (Array.isArray(processedData) ? processedData : []).some((file: any) => isTransferLikeFile(file)), [processedData]);
    useEffect(() => {
            ...
            vth: effectivePlotType === "vth"
                ? activeFile.series.map((series: any, index: number) => {
                    ...
                    return {
                        ...
                        name: label,
                        tooltipName: buildTooltipSeriesName(label, series?.id),
                        data: createVthSqrtPoints(pointsBySeriesId.get(series.id) ?? []),
                    };
                })
                : [],
    ...
    const yLogCurrentMode = useMemo(() => resolveYLogCurrentModeForFile(activeFile), [activeFile, resolveYLogCurrentModeForFile]);
    ...
    const plotLegendSeries = useMemo(() => getPlotLegendSeries<any>({
        effectivePlotType,
        plotSeriesByType,
    }), [effectivePlotType, plotSeriesByType]);
    const displayPlotSeries = useMemo(() => getDisplayPlotSeries<any>({
        plotLegendSeries,
        visibleSeriesKeySet: visibleSeriesKeySet as Set<string>,
        yLogCurrentMode,
        yScaleMode,
    ...
    const renderPointBudget = useMemo(() => getRenderPointBudget({
        defaultBudget: DEFAULT_RENDER_POINT_BUDGET,
        effectivePlotType,
        gmBudget: GM_RENDER_POINT_BUDGET,
    }), [effectivePlotType]);
    const renderMaxPointsPerSeries = useMemo(() => getRenderMaxPointsPerSeries({
        maxPoints: MAX_RENDER_SERIES_POINTS,
        minPoints: MIN_RENDER_SERIES_POINTS,
        renderPointBudget,
    ...
    const renderOriginSelectionLegend = React.useCallback(() => {
        ...
        return (jsx("ul", {
            className: "m-0 flex min-w-0 w-full list-none flex-col gap-0.5 overflow-hidden p-0",
            children: plotLegendSeries.map((series: any, idx: number) => {
                ...
                return (jsx(EditableLegendItem, {
                    key: seriesId || `${label}-${idx}`,
                    checked: checked,
                    color: color,
                    editHint: t("da_legend_edit_hint"),
                    disabled: disabled,
                    isEditing: isEditing,
                    label: label,
                    fontSize: mainPlotLegendFontSize,
                    onBeginEdit: () => beginLegendLabelEdit(activeLegendFileId, series, idx),
                    onCancelEdit: cancelLegendLabelEdit,
                    onCommitEdit: commitLegendLabelEdit,
                    onDraftChange: setEditingLegendDraft,
                    onToggleVisible: () => {
                        if (!disabled)
                            toggleVisibleSeries(seriesId);
                    },
                    draftValue: editingLegendDraft,
                    inputRef: isEditing ? editingLegendInputRef : undefined
                }));
            })
        }));
    ...
    useLayoutEffect(() => {
        if (!parametersViewRef.current)
            return;
        parametersPaneRef.current ??= new ParametersViewPane(parametersViewRef.current);
        parametersPaneRef.current.renderParameters({
            buildCurrentTooltip,
            buildSsTooltip,
            gmMetricHeader: gmUi.metricHeader,
            rows: metricsRows,
            showTransferMetrics: calculatedParametersMode === "transfer",
            t,
        });
    }, [buildCurrentTooltip, buildSsTooltip, calculatedParametersMode, gmUi.metricHeader, metricsRows, t]);
    const rcStatisticListEntries = useMemo(() => {
        return (Array.isArray(processedData) ? processedData : [])
            ...
            const selectedCount = series.filter((item: {
                selected: boolean;
    ...
    const rcRows = useMemo(() => {
        ...
        return rcStatisticListEntries.flatMap((entry: any) => {
            ...
            const seriesList = Array.isArray(file?.series) ? file.series : [];
            const selectedSeriesIds = new Set((Array.isArray(entry?.series) ? entry.series : [])
    ...
    const rcCurveChart = useMemo(() => createRcCurveChart(rcCurveRows), [rcCurveRows]);
    const rcStatusText = getRcStatusText({
        error: rcAnalyzeError,
    ...
    const handleAnalyzeRc = React.useCallback(async () => {
        const requestId = rcAnalyzeRequestIdRef.current + 1;
        rcAnalyzeRequestIdRef.current = requestId;
        setRcAnalyzePending(true);
        setRcAnalyzeError("");
        const result = await parametersService.runRcAnalysis({
            curveProbeX,
            importService,
            rows: rcRows,
            t,
        });
        if (!isMountedRef.current || rcAnalyzeRequestIdRef.current !== requestId) {
            return;
        }
        if (result.ok) {
            setRcAnalyzeResult(result.result);
        }
        else {
            setRcAnalyzeError(result.error);
            setRcAnalyzeResult(null);
        }
        setRcAnalyzePending(false);
    }, [curveProbeX, parametersService, rcRows, t]);
    useEffect(() => {
        if (resultsTab !== "rc" || !rcToolbarRef.current)
            return undefined;
        return renderRcAnalysisToolbar(rcToolbarRef.current, {
    ...
    useLayoutEffect(() => {
        if (resultsTab !== "rc" || !rcSummaryRef.current)
            return;
        rcSummaryPaneRef.current ??= new ParametersViewPane(rcSummaryRef.current);
        rcSummaryPaneRef.current.renderRcSummary({
            error: rcAnalyzeError,
            summary: rcSummary,
            t,
        });
    }, [rcAnalyzeError, rcSummary, resultsTab, t]);
    useLayoutEffect(() => {
        if (resultsTab !== "rc" || !rcCurveHeaderRef.current || !rcCurveChart)
            return;
        rcCurveHeaderPaneRef.current ??= new ParametersViewPane(rcCurveHeaderRef.current);
        rcCurveHeaderPaneRef.current.renderRcCurveHeader({
            series: rcCurveChart.series,
            t,
        });
    }, [rcCurveChart, resultsTab, t]);
    useLayoutEffect(() => {
        if (resultsTab !== "rc" || !rcCurveRowsRef.current)
            return;
        rcCurveRowsPaneRef.current ??= new ParametersViewPane(rcCurveRowsRef.current);
        rcCurveRowsPaneRef.current.renderRcCurveRows({
            rows: rcCurveRows,
            t,
        });
    }, [rcCurveRows, resultsTab, t]);
    const diagnosticsContextBadges = useMemo(() => createDiagnosticsContextBadges({
        effectivePlotType,
        focusedSeriesColor,
        focusedSeriesLabel,
    ...
    const renderOriginCurveSelectionList = React.useCallback(({ curveMode = resolvedCurveExportMode, entries, emptyText, isSelectionMode = isExportListCanvasSelectionMode, onClearAllSeriesForFile = clearOriginSeriesSelectionForFile, onToggleFile = toggleOriginCanvasSelection, onSelectAllSeriesForFile = selectAllOriginSeriesForFile, onSetCurveMode = setOriginCurveExportMode, onToggleSeriesForFile = toggleOriginSeriesSelectionForFile, renderFileExtra, showRemoveButton = true, showSeriesControls = true, }: {
        curveMode?: OriginCurveExportMode;
        ...
        axis: "y",
        className: "min-w-0 w-full max-h-[320px]",
        viewportClassName: "pr-2",
        children: jsx("div", {
            className: "space-y-2",
            children: entries.map((entry: any) => (jsx(OriginCurveSelectionEntryRow, {
                key: entry.fileId,
                curveMode: curveMode,
                entry: entry,
        ...
        className: "rounded-xl border border-dashed border-border bg-bg-page/40 px-4 py-6 text-sm text-text-secondary",
        children: emptyText
    })), [
    ...
    if (!processedData || processedData.length === 0)
        return null;
    const sidebarContent = (jsx("aside", {
        id: "analysis-overview-sidebar",
        className: "flex h-full min-h-0 flex-col",
        children: showPlotSettingsPane ? (jsx(AxisSettingsPane, {
            axis: axis,
            setAxis: setAxis,
            ...
            onSelectFile: handleSelectFile,
            onVisibleFileIdsChange: setOverviewVisibleFileIds,
            selectedOriginCanvasKeySet: selectedOriginCanvasKeySet,
            onToggleOriginCanvasSelection: toggleOriginCanvasSelection,
            originCanvasExportScope: originCanvasExportScope,
            isSelectionMode: isManualCanvasScope,
            xUnitFactor: resolvedXUnitMeta.factor,
            xUnitLabel: resolvedXUnitMeta.label,
            resolveYUnitForFile: resolveYUnitForFile,
            resolveYScaleForFile: resolveLinearLogYScaleForFile,
            resolveYLogCurrentModeForFile: resolveYLogCurrentModeForFile
        }))
    }));
    return (jsxs("div", {
                ...
                panes: [
                    {
                        ...
                        children: (jsx(ScrollArea, {
                            className: "da-analysis-scroll-area min-w-0 min-h-0",
                            axis: "y",
                                    ...
                                    children: [
                                        jsx("div", {
                                            ...
                                            children: jsxs("div", {
                                                ...
                                                children: [
                                                    jsx(PlotTypeToggle, {
                                                        activePlotType: effectivePlotType,
                                                        primaryPlotLabel: primaryPlotLabel,
                                                        derivativeLabel: gmUi.kind === "gds" ? "gds" : "gm",
                                                        gmApplicable: gmApplicable,
                                                        ssApplicable: ssApplicable,
                                                        vthApplicable: vthApplicable,
                                                        areaAvailable: Boolean(area),
                                                    ...
                                                    jsxs("div", {
                                                        ...
                                                        children: [
                                                            jsx(DropdownField, {
                                                                ...
                                                                "aria-label": t("da_chart_y_unit_aria_label"),
                                                                className: "w-fit da-neutral-select",
                                                                stableWidth: true,
                                                                "data-cta": "Device Analysis",
                                                                "data-cta-position": "y-unit",
                                                                "data-cta-copy": "y unit"
                                                            }),
                                                            jsxs("div", {
                                                                className: "flex items-center gap-1",
                                                                children: [
                                                                    effectivePlotType === "ss" ? (jsx("span", {
                                                                        className: "text-xs text-text-primary font-mono whitespace-nowrap",
                                                                        children: "log(|I|)"
                                                                    })) : effectivePlotType === "vth" ? null : (jsx(DropdownField, {
                                                                        id: "analysis-y-scale-select",
                                                                        size: "sm",
                                                                        ...
                                                                        "aria-label": t("da_chart_y_scale_aria_label"),
                                                                        className: "w-fit da-neutral-select",
                                                                        stableWidth: true,
                                                                        "data-cta": "Device Analysis",
                                                                        "data-cta-position": "y-scale",
                                                                        "data-cta-copy": "y scale"
                                                                    })),
                                                                    effectivePlotType !== "ss" && effectivePlotType !== "vth" && yScaleMode === "log" ? (jsx(DropdownField, {
                                                                        id: "analysis-log-current-mode-select",
                                                                        size: "sm",
                                                                        value: yLogCurrentMode,
                                                                        onChange: (next: any) => {
                                                                        ...
                                                                        "aria-label": t("da_log_current_mode_aria_label"),
                                                                        className: "w-fit da-neutral-select",
                                                                        stableWidth: true,
                                                                        "data-cta": "Device Analysis",
                                                                        "data-cta-position": "log-current-mode",
                                                                        "data-cta-copy": "log current mode"
                                                                    })) : null
                                                                ]
                                                            }),
                                                            effectivePlotType === "gm" ? (jsx("div", {
                                                                ...
                                                                children: jsx(Button, {
                                                                    ...
                                                                    title: t("da_chart_gm_second_diagnostics", { label: gmUi.kindSymbol ?? gmUi.metricSymbol }),
                                                                    children: t("da_chart_gm_second_diagnostics", { label: gmUi.kindSymbol ?? gmUi.metricSymbol })
                                                                })
                                                            })) : null,
                                                            effectivePlotType === "ss" ? (jsxs("div", {
                                                                className: "flex items-center gap-2",
                                                                children: [
                                                                    jsxs("div", {
                                                                        className: "flex items-center gap-1",
                                                                    ...
                                                                    jsx(Button, {
                                                                        ...
                                                                        className: "h-8 px-2 text-xs",
                                                                        title: t("da_chart_ss_diagnostics_toggle_title"),
                                                                        children: t("da_chart_ss_diagnostics")
                                                                    })
                                                                ]
                                                            })) : null,
                                                            effectivePlotType === "vth" ? (jsx("div", {
                                                                ...
                                                                children: jsx(Button, {
                                                                    ...
                                                                    className: "h-8 px-2 text-xs",
                                                                    title: t("da_chart_vth_diagnostics_toggle_title"),
                                                                    children: t("da_chart_vth_diagnostics")
                                                                })
                                                            })) : null,
                                                            showIonIoffControl ? (jsx("div", {
                                                                className: "flex items-center gap-2",
                                                                children: jsxs("div", {
                                                                    className: "flex items-center gap-1",
                                                                    children: [
                                                                        ...
                                                                        jsx(DropdownField, {
                                                                            id: "analysis-current-method-select",
                                                                            size: "sm",
                                                                            value: ionIoffMethod,
                                                                            onChange: (next: any) => {
                                                            ...
                                                            showFileSelect ? (jsx(DropdownField, {
                                                                id: "analysis-file-select",
                                                                size: "sm",
                                                                value: effectiveActiveFileId ?? "",
                                                                onChange: (val: any) => handleSelectFile(val),
                                                                options: processedData.map((f: any) => ({
                                                                    value: f.fileId,
                                                                    label: f.fileName,
                                                                })),
                                                                className: "w-[240px] da-neutral-select",
                                                                placeholder: t("da_select_file_placeholder"),
                                                                "data-cta": "Device Analysis",
                                                            ...
                                                            jsxs(Button, {
                                                                ...
                                                                variant: "secondary",
                                                                size: "sm",
                                                                onClick: () => setShowPlotSettingsPane((v: any) => !v),
                                        ...
                                        activeFile?.series?.length ? (jsxs("div", {
                                            className: "flex flex-col",
                                            children: [
                                                jsx("div", {
                                                    ref: mainChartContainerRef,
                                                    className: "h-[500px] min-h-[500px] flex-shrink-0",
                                                    children: jsx(MainPlotChart, {
                                                        ...
                                                        onXAxisLabelChange: (nextLabel: string) => {
                                                            const event = createChartAxisTitleChangeEvent("x", nextLabel);
                                                            setActiveAxisTitleOverride(event.axis, event.title);
                                                        },
                                                        onYAxisLabelChange: (nextLabel: string) => {
                                                            const event = createChartAxisTitleChangeEvent("y", nextLabel);
                                                            setActiveAxisTitleOverride(event.axis, event.title);
                                                        }
                                                    })
                                                }),
                                                !hasVisiblePlotSeries ? (jsx("div", {
                                                    className: "mt-2 rounded-lg border border-dashed border-border/70 bg-bg-page/40 px-3 py-2 text-sm text-text-secondary",
                                                    children: t("da_chart_no_visible_curves")
                                                })) : null,
                                                effectivePlotType === "vth" ? (jsx("div", {
                                                    className: "mt-3 rounded-lg border border-border bg-bg-page/40 px-3 py-2",
                                                    children: focusedVthFitRows.length ? (jsx(ScrollArea, {
                                                        axis: "x",
                                                        className: "min-w-0 w-full",
                                                        children: jsxs("div", {
                                                            className: "min-w-[860px] text-xs",
                                                            children: [
                                                                jsxs("div", {
                                                                    className: "grid grid-cols-[96px_132px_190px_140px_160px_92px] items-center gap-x-3 border-b border-border/70 px-2 pb-1 text-text-secondary",
                                                                    children: [
                                                                        jsx("span", {
                                                                            children: t("da_vth_table_branch")
                                                                        }),
                                                                        jsx("span", {
                                                                        ...
                                                                        jsx("span", {
                                                                            className: "text-right",
                                                                            children: t("da_vth_table_fit_range")
                                                                        }),
                                                                        jsx("span", {
                                                                            className: "text-right",
                                                                            children: t("da_vth_table_slope")
                                                                        }),
                                                                        jsx("span", {
                                                                            className: "text-right",
                                                                            children: t("da_vth_table_intercept")
                                                                        }),
                                                                        jsx("span", {
                                                                            className: "text-right",
                                                                            children: "R\u00B2"
                                                                ...
                                                                jsx("div", {
                                                                    ...
                                                                    children: focusedVthFitRows.map((row: any) => (jsxs("div", {
                                                                        key: row.branch,
                                                                        className: "grid grid-cols-[96px_132px_190px_140px_160px_92px] items-center gap-x-3 px-2 py-1.5",
                                                                        children: [
                                                                            jsx("span", {
                                                                                className: "font-medium text-text-primary capitalize",
                                                                                children: row.branch === "electron"
                                                                            ...
                                                                            jsx("span", {
                                                                                className: "font-mono text-right text-text-primary whitespace-nowrap",
                                                                                children: row.vth
                                                                            }),
                                                                            jsx("span", {
                                                                                className: "font-mono text-right text-text-primary whitespace-nowrap",
                                                                                children: row.fitRange
                                                                            }),
                                                                            jsx("span", {
                                                                                className: "font-mono text-right text-text-primary whitespace-nowrap",
                                                                                children: row.slope
                                                        ...
                                                        children: t("da_vth_no_stable_fit")
                                                    }))
                                                })) : null,
                                                effectivePlotType === "vth" && vthDiagnosticsEnabled && visibleVthSlopeDiagnosticsSeriesForRender.length ? (jsxs("div", {
                                                    className: "mt-4",
                                                    children: [
                                                        jsx("div", {
                                                        ...
                                                        jsx("div", {
                                                            ...
                                                            children: jsx(GmDiagnosticsChart, {
                                                                series: visibleVthSlopeDiagnosticsSeriesForRender,
                                                                axisTitleFontSize: mainPlotAxisTitleFontSize,
                                                                curveProbeX: curveProbeX,
                                                                tickLabelFontSize: mainPlotTickLabelFontSize,
                                                                xDomain: xDomain,
                                                                ...
                                                                xTickDigits: xTickDigitsDisplay,
                                                                xTooltipDigits: xTooltipDigits,
                                                                yDomain: vthSlopeDiagnosticsYDomain,
                                                                yTicks: vthSlopeDiagnosticsYTicks,
                                                                referenceLines: focusedVthSlopeReferenceLines,
                                                                rightReservedWidth: MAIN_PLOT_LEGEND_WIDTH,
                                                                yAxisLabel: "d√|Id|/dVg",
                                                                valueUnitLabel: `${plotYUnitLabel}/${resolvedXUnitMeta.label || "V"}`
                                                            })
                                                        })
                                                    ]
                                                })) : null,
                                                effectivePlotType === "ss" && visibleSsDiagnosticsSeriesForRender.length ? (jsxs("div", {
                                                    className: "mt-4",
                                                    children: [
                                                        ssSummary ? (jsx("div", {
                                                            className: "mb-3",
                                                            children: jsx(SsSummaryStrip, {
                                                                summary: ssSummary
                                                            })
                                                        })) : null,
                                                        jsx("div", {
                                                        ...
                                                        jsx("div", {
                                                            ref: diagnosticsChartContainerRef,
                                                            className: "h-[260px] min-h-[260px] flex-shrink-0",
                                                            children: jsx(SsDiagnosticsChart, {
                                                                series: visibleSsDiagnosticsSeriesForRender,
                                                                axisTitleFontSize: mainPlotAxisTitleFontSize,
                                                                curveProbeX: curveProbeX,
                                                                tickLabelFontSize: mainPlotTickLabelFontSize,
                                                                xDomain: xDomain,
                                                                ...
                                                                xTickDigits: xTickDigitsDisplay,
                                                                xTooltipDigits: xTooltipDigits,
                                                                yDomain: ssDiagnosticsYDomain,
                                                                yTicks: ssDiagnosticsYTicks,
                                                                overlay: focusedSsOverlay,
                                                                overlayStyle: ssOverlayStyle,
                                                                ssReferenceValue: ssSummary?.ss,
                                                                seriesColor: focusedSeriesColor,
                                                                rightReservedWidth: MAIN_PLOT_LEGEND_WIDTH
                                                            })
                                                        })
                                                    ]
                                                })) : null,
                                                effectivePlotType === "gm" && gmDiagnosticsEnabled && visibleGmDiagnosticsSeriesForRender.length ? (jsxs("div", {
                                                    className: "mt-4",
                                                    children: [
                                                        jsx("div", {
                                                            className: "text-xs text-text-secondary mb-2",
                                                        ...
                                                        jsx("div", {
                                                            ...
                                                            children: t("da_chart_gm_second_note", { label: gmUi.kindSymbol ?? gmUi.metricSymbol, axisLabel: gmSecondDerivativeAxisLabel })
                                                        }),
                                                        jsx("div", {
                                                            ref: diagnosticsChartContainerRef,
                                                            className: "h-[260px] min-h-[260px] flex-shrink-0",
                                                            children: jsx(GmDiagnosticsChart, {
                                                                series: visibleGmDiagnosticsSeriesForRender,
                                                                axisTitleFontSize: mainPlotAxisTitleFontSize,
                                                                curveProbeX: curveProbeX,
                                                                tickLabelFontSize: mainPlotTickLabelFontSize,
                                                                xDomain: xDomain,
                                                                ...
                                                                xTickDigits: xTickDigitsDisplay,
                                                                xTooltipDigits: xTooltipDigits,
                                                                yDomain: gmDiagnosticsYDomain,
                                                                yTicks: gmDiagnosticsYTicks,
                                                                rightReservedWidth: MAIN_PLOT_LEGEND_WIDTH,
                                                                yAxisLabel: gmSecondDerivativeAxisLabel,
                                                                valueUnitLabel: gmSecondDerivativeUnitLabel
                                                            })
                                                        })
                                                    ]
                                                })) : null
                                            ...
                                            className: "flex items-center justify-center h-[300px] text-text-secondary",
                                            children: t("da_chart_no_series_data")
                                        }))
                                    ]
                                })
                            })
                    ...
                    },
                    {
                        ...
                        children: (jsx(ScrollArea, {
                            ...
                            children: jsx("section", {
                                className: "flex min-w-0 flex-col",
                                children: jsx(AnalysisDiagnosticsCard, {
                        ...
                        children: (jsx(ScrollArea, {
                            ...
                            children: jsx("section", {
                                ...
                                children: activeFile?.series?.length ? (jsxs(Card, {
                                    ...
                                    children: [
                                        jsxs("div", {
                                            className: "mb-3 flex min-w-0 items-center justify-between gap-3 flex-wrap",
                                            children: [
                                                jsx("div", {
                                                    className: "flex min-w-0 items-center flex-wrap",
                                                    children: jsx(Tabs, {
                                                        idBase: "analysis-results-tabs",
                                                        value: resultsTab,
                                                        onChange: (next: unknown) => setResultsTab(next === "export" || next === "rc" ? next : "metrics"),
                                                        size: "sm",
                                                        hoverPreview: false,
                                                        groupLabel: t("da_analysis_results_tabs_label"),
                                                        itemClassName: "!px-3",
                                                        options: [
                                                            {
                                                                value: "metrics",
                                                ...
                                                jsx("div", {
                                                    ...
                                                    children: resultsTab === "metrics" ? metricsProgressText : resultsTab === "rc" ? rcStatusText : exportSelectionSummary
                                                })
                                            ]
                                        }),
                                        resultsTab === "metrics" ? (jsx(ScrollArea, {
                                            axis: "x",
                                            className: "da-calculated-parameters-scroll-area min-w-0 w-full",
                                            children: jsx("div", {
                                                ref: parametersViewRef
                                            })
                                        })) : resultsTab === "rc" ? (jsxs("div", {
                                            ...
                                            children: [
                                                    ...
                                                    renderFileExtra: (entry: any) => {
                                                        ...
                                                        return (jsxs(Fragment, {
                                                            children: [
                                                                ...
                                                                entry.isCanvasSelected && !rows.length ? (jsx("div", {
                                                                    className: "text-xs text-text-secondary",
                                                                    children: t("da_rc_require_curve_in_file")
                                                                })) : null
                                                            ]
                                                        }));
                                                    },
                                                ...
                                                rcCurveChart ? (jsxs("div", {
                                                    className: "rounded-xl border border-border bg-bg-page/40 px-3 py-3",
                                                    children: [
                                                        jsx("div", {
                                                            ref: rcCurveHeaderRef
                                                        }),
                                                        jsx("div", {
                                                            className: "h-[220px] min-w-0",
                                                            children: jsx(CanvasDiagnosticsChart, {
