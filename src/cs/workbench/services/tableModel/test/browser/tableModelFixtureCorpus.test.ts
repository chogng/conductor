...
suite("workbench/services/tableModel/test/browser/tableModelFixtureCorpus", () => {
	const store = ensureNoDisposablesAreLeakedInTestSuite();
	const fixtures: readonly TableModelFixture[] = [
		{
			id: "iv-transfer",
