...
} from "../../common/importTableModelSeedHeuristics.ts";
import { ensureNoDisposablesAreLeakedInTestSuite } from "src/cs/base/test/common/lifecycleTestUtils";

suite("workbench/services/tableModel/test/common/importTableModelSeedHeuristics", () => {
  ensureNoDisposablesAreLeakedInTestSuite();
  test("classifies standard transfer metadata with high confidence", () => {
    const metadata = extractImportTableModelSeedMetadata([
    ...
    const result = createImportTableModelSeedHeuristic({
  ...
  test("classifies Cp-V files as cv without review", () => {
    const result = createImportTableModelSeedHeuristic({
      ...
      metadata: extractImportTableModelSeedMetadata([
  ...
  test("extractImportTableModelSeedMetadata keeps stripped sweep stats to the first VAR2 segment", () => {
    const metadata = extractImportTableModelSeedMetadata([
      [
        "Repeat",
        "VAR2",
