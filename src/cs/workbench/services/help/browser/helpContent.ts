      ...
      sections: [
        {
          ...
          body: [
            localize("help_guide_import_body_1", "Drag files or folders into Explorer, or use the import entry to choose local data."),
    ...
    sections: [
      {
        ...
        body: [
          ...
          localize("help_changelog_current_body_2", "Update log entries can be appended in src/cs/workbench/services/help/browser/helpContent.ts."),
        ],
      },
      {
