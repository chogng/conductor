...
import { RawTableFactsEngine } from "src/cs/workbench/services/tableFacts/browser/rawTableFactsEngine";
import {
...
export class RawTableFactsService extends Disposable implements IRawTableFactsServiceType {
  ...
  private readonly rawTableFactsEngine = new RawTableFactsEngine();
  ...
  public async createRawTableFacts(
    ...
    return this.rawTableFactsEngine.assess({
      ...input,
      schemaProfiles,
