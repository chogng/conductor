...
const SplitView = forwardRef<HTMLDivElement, SplitViewProps>(
  (
    ...
    return jsx("div", {
      ...
      children: [
        jsx("div", {
          className: getGridViewClassName("ui-split-view__grid"),
          "data-orientation": orientation,
          style: getGridViewStyle({ gap, orientation, sizes }),
          children: panes.map((pane) => jsx("div", {
            className: getGridViewItemClassName(cx("ui-split-view__pane", pane.className)),
