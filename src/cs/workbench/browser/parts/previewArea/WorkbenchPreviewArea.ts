...
import type {
  ...
  WorkbenchPreviewAreaActionHandler,
  WorkbenchPreviewAreaBadge,
  WorkbenchPreviewAreaHeaderAction,
  WorkbenchPreviewAreaPartState,
} from "src/cs/workbench/browser/parts/previewArea/previewPart";

export type WorkbenchPreviewAreaProps = WorkbenchPreviewAreaPartState & {
  ariaLabel?: string;
  children?: ReactNode;
...
export default WorkbenchPreviewArea;
