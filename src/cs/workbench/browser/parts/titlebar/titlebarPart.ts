...
import { WorkbenchCommandId } from "src/cs/workbench/browser/parts/titlebar/titlebarActions";
...
const createWorkbenchTitlebarPageActions = (
  ...
  {
    commandId: WorkbenchCommandId.showTable,
    id: "table",
    title: localize("titlebar.mode.table", "Table"),
    isActive: activePage === "table",
  },
  {
    commandId: WorkbenchCommandId.showChart,
    id: "chart",
...
(): WorkbenchTitlebarWindowAction[] => [
  {
    commandId: WorkbenchCommandId.minimizeWindow,
    id: "minimize",
    title: localize("menu_window_minimize", "Minimize Window"),
  },
  {
    commandId: WorkbenchCommandId.toggleMaximizeWindow,
    id: "maximize",
    title: localize("menu_window_maximize", "Maximize / Restore"),
  },
  {
    commandId: WorkbenchCommandId.closeWindow,
    id: "close",
...
export const createWorkbenchTitlebarElement = (
  ...
  const sidebarButton = createIconButton(
    ...
    () => {
      void commandService?.executeCommand(WorkbenchCommandId.toggleSidebar);
    },
  );
